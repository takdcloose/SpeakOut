...
<div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; bottom: #transparent-sticky-navbar">
    <nav class="uk-navbar-container" uk-navbar>
        ...
        <div class="uk-navbar-right">
            <ul class="uk-subnav uk-text-center uk-margin-top uk-margin-small-right"  uk-margin>
                <li><?php
                if($login){
                    echo "
                    ...
                    <li><a href=\"../../util/logout.php\"><button class=\"uk-button uk-button-text uk-text-meta\">".$logout."</button></a></li><li><a href='../".$re["username"]."/index.php'><button class=\"uk-button uk-button-text uk-text-meta\">".$mypage."</button></a></li>";
                }else{
                    echo "
                    <form action='".$_SERVER['PHP_SELF']."' method='post'>
                        <input type='hidden' name='lan' value='".$language."'>
